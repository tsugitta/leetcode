...
import (
	...
	"github.com/tsugitta/leetcode/generator/program"
...
func main() {
	...
	app.Name = "LeetCode preparer"
	app.Usage = "Prepare boilerplate for the passed URL. Run at root dir."
	app.Version = "0.0.1"
	...
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:  "lang, l",
			Value: "cpp",
			Usage: "Language to use. only cpp is supported for now.",
		},
	}
